...
export const Component = () => {
    return (
        <div className="w-[500px] h-[100px]">
            <VaporizeTextCycle texts={["Next.js", "React", "Tailwind"]} />
        </div>
    )
}
...
export default function VaporizeTextCycle({
  ...
  return (
    <div ref={wrapperRef} style={wrapperStyle} className="relative">
      <SeoElement tag={tag} texts={texts} />
      <canvas ref={canvasRef} style={canvasStyle} className="block w-full h-full" />
    </div>
  );
}
